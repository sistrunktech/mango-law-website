...
export default function SiteHeader({ onOpenLeadModal }: SiteHeaderProps) {
  ...
  return (
    ...
    >
      {showDuiMapBanner && (
        <div className="border-b border-brand-black/10 bg-brand-leaf text-white lg:hidden">
          <div className="container flex items-center justify-between gap-3 py-2">
            ...
            >
              <MapPinned className="h-4 w-4 shrink-0 text-brand-mango" aria-hidden="true" />
              <span className="truncate">Live DUI Checkpoint Map</span>
              <span className="shrink-0 rounded-full bg-white/15 px-2 py-0.5 text-xs font-semibold text-white">
                View
              </span>
            </Link>
            <button
