...
export default function StatCard({
  ...
  const colorClasses = {
    mango: 'from-brand-mango/10 to-brand-mango/5 border-brand-mango/20 text-brand-mango',
    gold: 'from-brand-gold/10 to-brand-gold/5 border-brand-gold/30 text-brand-gold',
