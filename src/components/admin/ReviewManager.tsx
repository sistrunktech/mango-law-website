      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-[#2F5F4F] rounded-lg p-6 border border-white/10">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-300 text-sm">Total Reviews</span>
        ...
        <div className="bg-[#2F5F4F] rounded-lg p-6 border border-white/10">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-300 text-sm">Needs Response</span>
        ...
        <div className="bg-[#2F5F4F] rounded-lg p-6 border border-white/10">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-300 text-sm">Responded</span>
