...
export default function DelawareOhioOviLawyerPage() {
  return (
    <>
          ...
          <div className="grid gap-10 lg:grid-cols-[2fr,1fr] lg:items-start">
            ...
            <div className="rounded-2xl border border-brand-black/10 bg-brand-offWhite p-6">
              ...
              <ul className="mt-3 space-y-2 text-sm text-brand-black/70">
                <li>
                  <Link href="/ovi-dui-defense-delaware-oh" className="text-brand-mango hover:text-brand-leaf">
                    OVI defense overview
                  </Link>
                </li>
                <li>
                  <Link href="/ovi-checkpoints-ohio" className="text-brand-mango hover:text-brand-leaf">
                    Ohio checkpoint rights
                  </Link>
                </li>
                <li>
                  <Link href="/resources/dui-checkpoints" className="text-brand-mango hover:text-brand-leaf">
                    Checkpoint map
                  </Link>
                </li>
              </ul>
      ...
      <FAQSection faqs={delawareOviFaqs} title="Delaware OVI defense FAQ" />
