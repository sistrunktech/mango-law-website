...
export const serviceAreas: ServiceArea[] = [
  ...
  },
  {
    ...
    type: 'city',
    county: 'Delaware County',
    description: 'Serving Sunbury and eastern Delaware County with experienced criminal defense advocacy.',
    tier: 1,
    slug: 'sunbury',
  },
  {
    ...
    type: 'city',
    county: 'Franklin County',
    description: 'Providing strategic defense for New Albany residents in Franklin and Licking County courts.',
    tier: 1,
    slug: 'new-albany',
  },
  {
    ...
    type: 'city',
    county: 'Delaware County',
    description: 'Experienced OVI and criminal defense for Powell residents in Delaware County courts.',
    tier: 1,
    slug: 'powell',
  },
  {
    ...
    type: 'city',
    county: 'Franklin County',
    description: 'Serving Worthington with dedicated criminal defense and OVI representation.',
    tier: 1,
    slug: 'worthington',
  },
  {
    ...
    type: 'city',
    county: 'Franklin County',
    description: 'Representing Grandview Heights clients in Columbus Municipal and Franklin County courts.',
    tier: 1,
  ...
  },
  {
    ...
    description: 'The primary hub for our Morrow County defense practice, serving clients in Mt. Gilead courts.',
    tier: 2,
    slug: 'mt-gilead',
  },
  {
    ...
    description: 'Serving the city of Marion with aggressive criminal defense and drug crime representation.',
    tier: 2,
    slug: 'marion',
  },
  {
    ...
    type: 'city',
    county: 'Delaware County',
    description: 'Providing legal services to the Ashley community in northern Delaware County.',
    tier: 3,
    slug: 'ashley',
  },
  {
    ...
    type: 'city',
    county: 'Delaware County',
    description: 'Representing Ostrander residents in Delaware County Municipal and Common Pleas courts.',
    tier: 3,
    slug: 'ostrander',
  },
  {
    ...
    type: 'city',
    county: 'Delaware County',
    description: 'Comprehensive criminal defense for Lewis Center residents near our primary office.',
    tier: 1,
    slug: 'lewis-center',
  },
  {
  ...
  },
  {
    ...
    hubCities: ['Columbus', 'Dublin', 'Westerville', 'Worthington', 'Gahanna', 'Hilliard', 'Upper Arlington', 'Grove City', 'Grandview Heights', 'New Albany'],
    courts: ['Franklin County Common Pleas Court', 'Columbus Municipal Court'],
    primaryPracticeFocus: ['OVI / DUI Defense', 'Criminal Defense', 'Weapons Charges'],
  },
  {
    id: 'union-county',
    name: 'Union County',
    type: 'county',
    description: 'Strategic criminal defense and OVI representation in Marysville and throughout Union County. Former prosecutor insight for Municipal and Common Pleas court matters.',
    tier: 2,
    slug: 'union-county',
    hubCities: ['Marysville'],
    courts: ['Union County Common Pleas Court', 'Marysville Municipal Court'],
    primaryPracticeFocus: ['OVI / DUI Defense', 'Drug Crimes', 'Criminal Defense'],
  },
  {
    id: 'morrow-county',
    name: 'Morrow County',
    type: 'county',
    description: 'Aggressive defense for OVI and traffic enforcement in Mt. Gilead and Morrow County. Protecting rights in rural jurisdictions with technical expertise.',
    tier: 2,
    slug: 'morrow-county',
    hubCities: ['Mt. Gilead'],
    courts: ['Morrow County Common Pleas Court', 'Morrow County Municipal Court'],
    primaryPracticeFocus: ['OVI / DUI Defense', 'Criminal Defense'],
  },
  {
    id: 'marion-county',
    name: 'Marion County',
    type: 'county',
    description: 'Comprehensive criminal defense services in Marion City and Marion County. Experienced representation for high-volume drug crimes and felony matters.',
    tier: 2,
    slug: 'marion-county',
    hubCities: ['Marion'],
    courts: ['Marion County Common Pleas Court', 'Marion County Municipal Court'],
    primaryPracticeFocus: ['Criminal Defense', 'Drug Crimes', 'OVI / DUI Defense'],
  },
];
