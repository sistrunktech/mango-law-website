...
print_head "${BASE_URL}/dui-checkpoints"
print_head "${BASE_URL}/criminal-defense"
print_head "${BASE_URL}/practice-area"
print_head "${BASE_URL}/blog/ohio-dui-look-back-period"
print_head "${BASE_URL}/blog/understanding-ovi-dui-charges"
